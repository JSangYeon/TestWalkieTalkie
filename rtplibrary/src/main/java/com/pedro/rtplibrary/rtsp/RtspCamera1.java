...
public class RtspCamera1 extends Camera1Base {
  ...
  protected void startStreamRtp(String url) {
    ...
    if(com.pedro.rtsp.rtsp.RtspClient.Companion.isPause())
    {
      Log.d("startStreamRtp","replay isPause : " + com.pedro.rtsp.rtsp.RtspClient.Companion.isPause());
      rtspClient.replay();
    }
    else{
      Log.d("startStreamRtp","connect isPause : " + com.pedro.rtsp.rtsp.RtspClient.Companion.isPause());
